...
from pwnagent.report.dedupe import (
...
from pwnagent.tools.reporting.tool import (
    _do_create,
...
async def test_dependency_report_dedupe_candidate_includes_dependency_metadata(
    ...
    monkeypatch.setattr("pwnagent.report.dedupe.check_duplicate", fake_check_duplicate)
