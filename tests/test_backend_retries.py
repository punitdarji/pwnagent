...
from pwnagent.runtime.backends import start_session_with_retry
...
async def test_transient_workspace_failure_retries_and_tears_down(
    ...
    monkeypatch.setattr("pwnagent.runtime.backends.asyncio.sleep", record_sleep)
...
async def test_staged_dirs_survive_retries_and_cleanup_once(
    ...
    monkeypatch.setattr("pwnagent.runtime.session_manager.shutil.rmtree", record_rmtree)
    monkeypatch.setattr(
        session_manager,
        "load_settings",
