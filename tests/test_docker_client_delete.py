"""PwnagentDockerSandboxClient.delete() best-effort teardown.
...
def _client_with_kill_error(exc: Exception) -> PwnagentDockerSandboxClient:
    """A PwnagentDockerSandboxClient whose containers.get(...).kill() raises ``exc``."""
    client = PwnagentDockerSandboxClient.__new__(PwnagentDockerSandboxClient)
