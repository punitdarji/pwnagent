# Contributing to Pwnagent

Thank you for your interest in contributing to Pwnagent! This guide will help you get started with development and contributions.
...
4. **Run Pwnagent in development mode**
   ```bash
   uv run pwnagent --target https://example.com
   ```

## 📚 Contributing Skills

Skills are specialized knowledge packages that enhance agent capabilities. See [pwnagent/skills/README.md](pwnagent/skills/README.md) for detailed guidelines.
