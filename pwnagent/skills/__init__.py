...
from pwnagent.utils.resource_paths import get_pwnagent_resource_path
...
def skill_search_dirs() -> tuple[Path, ...]:
    ...
    builtin = get_pwnagent_resource_path("skills")
    if builtin.is_dir():
...
def load_skills(skill_names: list[str]) -> dict[str, str]:
    ...
    Skill files live at ``pwnagent/skills/<category>/<name>.md`` (or any
