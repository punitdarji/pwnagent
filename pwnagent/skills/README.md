...
Skills are specialized knowledge packages that enhance Pwnagent agents with deep expertise in specific vulnerability types, technologies, and testing methodologies. Each skill provides advanced techniques, practical examples, and validation methods that go beyond baseline security knowledge.
...
Community contributions are more than welcome — contribute new skills via [pull requests](https://github.com/punitdarji/pwnagent/pulls) or [GitHub issues](https://github.com/punitdarji/pwnagent/issues) to help expand the collection and improve extensibility for Pwnagent agents.
