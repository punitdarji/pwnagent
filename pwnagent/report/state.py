...
from pwnagent.core.paths import run_dir_for
from pwnagent.report.sarif import write_sarif
from pwnagent.report.usage import LLMUsageLedger
from pwnagent.report.writer import (
    read_run_record,
...
def _pwnagent_version() -> str | None:
...
class ReportState:
    ...
    persistence. This store keeps only Pwnagent-owned scan artifacts and
        ...
        try:
            ...
            try:
                write_sarif(
                    ...
                    tool_version=_pwnagent_version(),
