---
title: "Contributing"
description: "Contribute to Pwnagent development"
---
...
Skills are specialized knowledge packages that enhance agent capabilities. They live in `pwnagent/skills/`
...
- Pwnagent version (`pwnagent --version`)
- LLM being used
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github" href="https://github.com/punitdarji/pwnagent/issues">
