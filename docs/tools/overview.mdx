---
title: "Agent Tools"
description: "How Pwnagent agents interact with targets"
---

Pwnagent agents use specialized tools to test your applications like a real penetration tester would.
