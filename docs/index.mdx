...
Pwnagent agents come equipped with a comprehensive toolkit:
...
Pwnagent uses a graph of specialized agents for comprehensive security testing:
...
<CardGroup cols={2}>
  <Card title="Discord" icon="discord" href="https://discord.gg/pwnagent-ai">
    Join the community for help and discussion.
  </Card>
  <Card title="GitHub" icon="github" href="https://github.com/punitdarji/pwnagent">
