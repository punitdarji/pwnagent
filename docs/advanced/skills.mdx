...
Skills are structured knowledge packages that give Pwnagent agents deep expertise in specific vulnerability types, technologies, and testing methodologies.
...
When Pwnagent spawns an agent for a specific task, it selects up to 5 relevant skills based on the context:
