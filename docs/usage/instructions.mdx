...
description: "Guide Pwnagent with custom testing instructions"
---
...
```bash
pwnagent --target https://app.com --instruction "Focus on authentication vulnerabilities"
```
...
```bash
pwnagent --target https://app.com --instruction-file ./pentest-instructions.md
```
...
```bash
pwnagent --target https://api.example.com \
...
<Tip>
Be specific. Good instructions help Pwnagent prioritize the most valuable attack paths.
</Tip>
