...
description: "Configure Pwnagent with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install Pwnagent with the vertex extra:

```bash
pipx install "pwnagent-agent[vertex]"
```

## Setup

```bash
export PWNAGENT_LLM="vertex_ai/gemini-3-pro-preview"
```
