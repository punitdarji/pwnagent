---
title: "AWS Bedrock"
description: "Configure Pwnagent with models via AWS Bedrock"
---

## Installation

Bedrock requires the AWS SDK dependency. Install Pwnagent with the bedrock extra:

```bash
pipx install "pwnagent-agent[bedrock]"
```

## Setup

```bash
export PWNAGENT_LLM="bedrock/anthropic.claude-4-5-sonnet-20251022-v1:0"
```
