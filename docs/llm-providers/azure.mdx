---
title: "Azure OpenAI"
description: "Configure Pwnagent with OpenAI models via Azure"
---

## Setup

```bash
export PWNAGENT_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `PWNAGENT_LLM` | `azure/<your-deployment-name>` |
...
```bash
export PWNAGENT_LLM="azure/gpt-5.4-deployment"
